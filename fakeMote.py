...
sensors = [{'Mote id': '3','Sensor or Actuator': 'sensor','Interface Type': 'SPI_ADC_2ch','Human Name':'PNTB','Pin':0,'P and ID':'PNTB','Unit': None,'Unpowered State': None}]
